 ...
 *
 * ```typescript
 * import { Icon4GPlusMobiledata } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <Icon4GPlusMobiledata />
 * }
 * ```
 *
 * @category Component
 */
export const Icon4GPlusMobiledata = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

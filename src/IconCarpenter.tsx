 ...
 *
 * ```typescript
 * import { IconCarpenter } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCarpenter />
 * }
 * ```
 *
 * @category Component
 */
export const IconCarpenter = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAssignmentInd } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAssignmentInd />
 * }
 * ```
 *
 * @category Component
 */
export const IconAssignmentInd = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

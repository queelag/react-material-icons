 ...
 *
 * ```typescript
 * import { IconFlourescent } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlourescent />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlourescent = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

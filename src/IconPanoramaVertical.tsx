 ...
 *
 * ```typescript
 * import { IconPanoramaVertical } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPanoramaVertical />
 * }
 * ```
 *
 * @category Component
 */
export const IconPanoramaVertical = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSportsGolf } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSportsGolf />
 * }
 * ```
 *
 * @category Component
 */
export const IconSportsGolf = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

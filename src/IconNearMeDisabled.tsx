 ...
 *
 * ```typescript
 * import { IconNearMeDisabled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNearMeDisabled />
 * }
 * ```
 *
 * @category Component
 */
export const IconNearMeDisabled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

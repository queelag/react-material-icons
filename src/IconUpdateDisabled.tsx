 ...
 *
 * ```typescript
 * import { IconUpdateDisabled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconUpdateDisabled />
 * }
 * ```
 *
 * @category Component
 */
export const IconUpdateDisabled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

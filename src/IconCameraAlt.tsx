 ...
 *
 * ```typescript
 * import { IconCameraAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCameraAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconCameraAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBikeScooter } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBikeScooter />
 * }
 * ```
 *
 * @category Component
 */
export const IconBikeScooter = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconLocalFireDepartment } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalFireDepartment />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalFireDepartment = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

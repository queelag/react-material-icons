 ...
 *
 * ```typescript
 * import { IconPersonOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPersonOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconPersonOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

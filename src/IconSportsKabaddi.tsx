 ...
 *
 * ```typescript
 * import { IconSportsKabaddi } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSportsKabaddi />
 * }
 * ```
 *
 * @category Component
 */
export const IconSportsKabaddi = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

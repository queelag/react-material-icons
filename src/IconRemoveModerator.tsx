 ...
 *
 * ```typescript
 * import { IconRemoveModerator } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRemoveModerator />
 * }
 * ```
 *
 * @category Component
 */
export const IconRemoveModerator = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

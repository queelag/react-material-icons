 ...
 *
 * ```typescript
 * import { IconRotate90DegreesCcw } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRotate90DegreesCcw />
 * }
 * ```
 *
 * @category Component
 */
export const IconRotate90DegreesCcw = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

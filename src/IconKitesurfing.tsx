 ...
 *
 * ```typescript
 * import { IconKitesurfing } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconKitesurfing />
 * }
 * ```
 *
 * @category Component
 */
export const IconKitesurfing = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

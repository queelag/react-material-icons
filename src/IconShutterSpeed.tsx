 ...
 *
 * ```typescript
 * import { IconShutterSpeed } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconShutterSpeed />
 * }
 * ```
 *
 * @category Component
 */
export const IconShutterSpeed = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

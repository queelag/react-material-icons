 ...
 *
 * ```typescript
 * import { IconOfflineBolt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOfflineBolt />
 * }
 * ```
 *
 * @category Component
 */
export const IconOfflineBolt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

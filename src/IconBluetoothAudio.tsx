 ...
 *
 * ```typescript
 * import { IconBluetoothAudio } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBluetoothAudio />
 * }
 * ```
 *
 * @category Component
 */
export const IconBluetoothAudio = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

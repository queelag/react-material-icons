 ...
 *
 * ```typescript
 * import { IconElectricScooter } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconElectricScooter />
 * }
 * ```
 *
 * @category Component
 */
export const IconElectricScooter = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconOpenInFull } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOpenInFull />
 * }
 * ```
 *
 * @category Component
 */
export const IconOpenInFull = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

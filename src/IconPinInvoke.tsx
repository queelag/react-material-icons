 ...
 *
 * ```typescript
 * import { IconPinInvoke } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPinInvoke />
 * }
 * ```
 *
 * @category Component
 */
export const IconPinInvoke = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

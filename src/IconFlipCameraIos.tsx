 ...
 *
 * ```typescript
 * import { IconFlipCameraIos } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlipCameraIos />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlipCameraIos = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

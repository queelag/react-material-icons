 ...
 *
 * ```typescript
 * import { IconAlignHorizontalLeft } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAlignHorizontalLeft />
 * }
 * ```
 *
 * @category Component
 */
export const IconAlignHorizontalLeft = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSnippetFolder } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSnippetFolder />
 * }
 * ```
 *
 * @category Component
 */
export const IconSnippetFolder = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

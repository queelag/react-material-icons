 ...
 *
 * ```typescript
 * import { IconAlternateEmail } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAlternateEmail />
 * }
 * ```
 *
 * @category Component
 */
export const IconAlternateEmail = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

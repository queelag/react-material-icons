 ...
 *
 * ```typescript
 * import { IconPartyMode } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPartyMode />
 * }
 * ```
 *
 * @category Component
 */
export const IconPartyMode = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

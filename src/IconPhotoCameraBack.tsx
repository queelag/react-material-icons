 ...
 *
 * ```typescript
 * import { IconPhotoCameraBack } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhotoCameraBack />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhotoCameraBack = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

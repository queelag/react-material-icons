 ...
 *
 * ```typescript
 * import { IconPhoneInTalk } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhoneInTalk />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhoneInTalk = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAgriculture } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAgriculture />
 * }
 * ```
 *
 * @category Component
 */
export const IconAgriculture = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

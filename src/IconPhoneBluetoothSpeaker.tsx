 ...
 *
 * ```typescript
 * import { IconPhoneBluetoothSpeaker } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhoneBluetoothSpeaker />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhoneBluetoothSpeaker = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

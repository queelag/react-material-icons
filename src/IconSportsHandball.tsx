 ...
 *
 * ```typescript
 * import { IconSportsHandball } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSportsHandball />
 * }
 * ```
 *
 * @category Component
 */
export const IconSportsHandball = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

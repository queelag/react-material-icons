 ...
 *
 * ```typescript
 * import { IconRingVolume } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRingVolume />
 * }
 * ```
 *
 * @category Component
 */
export const IconRingVolume = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

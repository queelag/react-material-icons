 ...
 *
 * ```typescript
 * import { IconHighlightAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHighlightAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconHighlightAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

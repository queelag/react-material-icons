 ...
 *
 * ```typescript
 * import { IconWifiCalling } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWifiCalling />
 * }
 * ```
 *
 * @category Component
 */
export const IconWifiCalling = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

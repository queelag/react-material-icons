 ...
 *
 * ```typescript
 * import { IconDataUsage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDataUsage />
 * }
 * ```
 *
 * @category Component
 */
export const IconDataUsage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

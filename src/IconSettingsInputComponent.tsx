 ...
 *
 * ```typescript
 * import { IconSettingsInputComponent } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsInputComponent />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsInputComponent = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconScreenSearchDesktop } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconScreenSearchDesktop />
 * }
 * ```
 *
 * @category Component
 */
export const IconScreenSearchDesktop = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

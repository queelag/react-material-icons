 ...
 *
 * ```typescript
 * import { IconInventory2 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconInventory2 />
 * }
 * ```
 *
 * @category Component
 */
export const IconInventory2 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFormatListNumbered } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatListNumbered />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatListNumbered = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

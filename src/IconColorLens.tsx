 ...
 *
 * ```typescript
 * import { IconColorLens } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconColorLens />
 * }
 * ```
 *
 * @category Component
 */
export const IconColorLens = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconDoNotTouch } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDoNotTouch />
 * }
 * ```
 *
 * @category Component
 */
export const IconDoNotTouch = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBuildCircle } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBuildCircle />
 * }
 * ```
 *
 * @category Component
 */
export const IconBuildCircle = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconImageNotSupported } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconImageNotSupported />
 * }
 * ```
 *
 * @category Component
 */
export const IconImageNotSupported = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

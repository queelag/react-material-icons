 ...
 *
 * ```typescript
 * import { IconHearingDisabled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHearingDisabled />
 * }
 * ```
 *
 * @category Component
 */
export const IconHearingDisabled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

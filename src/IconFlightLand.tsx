 ...
 *
 * ```typescript
 * import { IconFlightLand } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlightLand />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlightLand = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

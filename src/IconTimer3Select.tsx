 ...
 *
 * ```typescript
 * import { IconTimer3Select } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTimer3Select />
 * }
 * ```
 *
 * @category Component
 */
export const IconTimer3Select = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

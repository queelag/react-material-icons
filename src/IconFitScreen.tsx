 ...
 *
 * ```typescript
 * import { IconFitScreen } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFitScreen />
 * }
 * ```
 *
 * @category Component
 */
export const IconFitScreen = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

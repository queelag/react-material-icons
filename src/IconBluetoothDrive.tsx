 ...
 *
 * ```typescript
 * import { IconBluetoothDrive } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBluetoothDrive />
 * }
 * ```
 *
 * @category Component
 */
export const IconBluetoothDrive = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

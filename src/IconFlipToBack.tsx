 ...
 *
 * ```typescript
 * import { IconFlipToBack } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlipToBack />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlipToBack = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconIntegrationInstructions } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconIntegrationInstructions />
 * }
 * ```
 *
 * @category Component
 */
export const IconIntegrationInstructions = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

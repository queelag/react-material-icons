 ...
 *
 * ```typescript
 * import { IconTextRotateUp } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTextRotateUp />
 * }
 * ```
 *
 * @category Component
 */
export const IconTextRotateUp = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

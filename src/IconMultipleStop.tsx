 ...
 *
 * ```typescript
 * import { IconMultipleStop } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMultipleStop />
 * }
 * ```
 *
 * @category Component
 */
export const IconMultipleStop = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

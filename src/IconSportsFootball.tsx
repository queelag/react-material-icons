 ...
 *
 * ```typescript
 * import { IconSportsFootball } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSportsFootball />
 * }
 * ```
 *
 * @category Component
 */
export const IconSportsFootball = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

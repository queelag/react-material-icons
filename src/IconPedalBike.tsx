 ...
 *
 * ```typescript
 * import { IconPedalBike } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPedalBike />
 * }
 * ```
 *
 * @category Component
 */
export const IconPedalBike = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

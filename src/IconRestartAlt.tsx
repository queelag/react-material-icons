 ...
 *
 * ```typescript
 * import { IconRestartAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRestartAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconRestartAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

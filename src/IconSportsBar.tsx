 ...
 *
 * ```typescript
 * import { IconSportsBar } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSportsBar />
 * }
 * ```
 *
 * @category Component
 */
export const IconSportsBar = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

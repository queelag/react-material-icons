 ...
 *
 * ```typescript
 * import { Icon4GMobiledata } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <Icon4GMobiledata />
 * }
 * ```
 *
 * @category Component
 */
export const Icon4GMobiledata = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconNearbyError } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNearbyError />
 * }
 * ```
 *
 * @category Component
 */
export const IconNearbyError = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconCalendarViewDay } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCalendarViewDay />
 * }
 * ```
 *
 * @category Component
 */
export const IconCalendarViewDay = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

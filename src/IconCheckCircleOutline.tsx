 ...
 *
 * ```typescript
 * import { IconCheckCircleOutline } from '@queelag/react-material-icons'
 *
 * function App() {
 ...
 * @category Component
 */
export const IconCheckCircleOutline = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconEmojiObjects } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEmojiObjects />
 * }
 * ```
 *
 * @category Component
 */
export const IconEmojiObjects = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

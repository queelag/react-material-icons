 ...
 *
 * ```typescript
 * import { IconCarRepair } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCarRepair />
 * }
 * ```
 *
 * @category Component
 */
export const IconCarRepair = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

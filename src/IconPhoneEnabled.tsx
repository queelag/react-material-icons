 ...
 *
 * ```typescript
 * import { IconPhoneEnabled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhoneEnabled />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhoneEnabled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSentimentVeryDissatisfied } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSentimentVeryDissatisfied />
 * }
 * ```
 *
 * @category Component
 */
export const IconSentimentVeryDissatisfied = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

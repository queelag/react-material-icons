 ...
 *
 * ```typescript
 * import { IconDataSaverOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDataSaverOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconDataSaverOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconMotionPhotosOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMotionPhotosOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconMotionPhotosOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSettingsOverscan } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsOverscan />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsOverscan = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

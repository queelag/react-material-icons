 ...
 *
 * ```typescript
 * import { IconLeakRemove } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLeakRemove />
 * }
 * ```
 *
 * @category Component
 */
export const IconLeakRemove = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

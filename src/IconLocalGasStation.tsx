 ...
 *
 * ```typescript
 * import { IconLocalGasStation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalGasStation />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalGasStation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

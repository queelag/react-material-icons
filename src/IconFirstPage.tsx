 ...
 *
 * ```typescript
 * import { IconFirstPage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFirstPage />
 * }
 * ```
 *
 * @category Component
 */
export const IconFirstPage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

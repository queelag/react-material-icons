 ...
 *
 * ```typescript
 * import { Icon30FpsSelect } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <Icon30FpsSelect />
 * }
 * ```
 *
 * @category Component
 */
export const Icon30FpsSelect = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

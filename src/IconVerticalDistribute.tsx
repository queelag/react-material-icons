 ...
 *
 * ```typescript
 * import { IconVerticalDistribute } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVerticalDistribute />
 * }
 * ```
 *
 * @category Component
 */
export const IconVerticalDistribute = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAddBusiness } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAddBusiness />
 * }
 * ```
 *
 * @category Component
 */
export const IconAddBusiness = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPestControl } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPestControl />
 * }
 * ```
 *
 * @category Component
 */
export const IconPestControl = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

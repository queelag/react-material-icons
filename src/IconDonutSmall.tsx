 ...
 *
 * ```typescript
 * import { IconDonutSmall } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDonutSmall />
 * }
 * ```
 *
 * @category Component
 */
export const IconDonutSmall = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

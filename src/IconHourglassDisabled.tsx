 ...
 *
 * ```typescript
 * import { IconHourglassDisabled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHourglassDisabled />
 * }
 * ```
 *
 * @category Component
 */
export const IconHourglassDisabled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

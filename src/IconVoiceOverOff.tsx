 ...
 *
 * ```typescript
 * import { IconVoiceOverOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVoiceOverOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconVoiceOverOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

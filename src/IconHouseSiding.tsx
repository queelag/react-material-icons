 ...
 *
 * ```typescript
 * import { IconHouseSiding } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHouseSiding />
 * }
 * ```
 *
 * @category Component
 */
export const IconHouseSiding = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

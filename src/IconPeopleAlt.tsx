 ...
 *
 * ```typescript
 * import { IconPeopleAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPeopleAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconPeopleAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPermContactCalendar } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPermContactCalendar />
 * }
 * ```
 *
 * @category Component
 */
export const IconPermContactCalendar = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

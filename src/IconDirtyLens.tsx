 ...
 *
 * ```typescript
 * import { IconDirtyLens } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDirtyLens />
 * }
 * ```
 *
 * @category Component
 */
export const IconDirtyLens = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

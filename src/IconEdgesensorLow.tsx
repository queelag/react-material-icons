 ...
 *
 * ```typescript
 * import { IconEdgesensorLow } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEdgesensorLow />
 * }
 * ```
 *
 * @category Component
 */
export const IconEdgesensorLow = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

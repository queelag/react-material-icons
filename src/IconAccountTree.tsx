 ...
 *
 * ```typescript
 * import { IconAccountTree } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAccountTree />
 * }
 * ```
 *
 * @category Component
 */
export const IconAccountTree = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

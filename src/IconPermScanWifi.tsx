 ...
 *
 * ```typescript
 * import { IconPermScanWifi } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPermScanWifi />
 * }
 * ```
 *
 * @category Component
 */
export const IconPermScanWifi = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

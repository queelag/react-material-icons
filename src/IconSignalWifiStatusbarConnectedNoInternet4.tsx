 ...
 *
 * ```typescript
 * import { IconSignalWifiStatusbarConnectedNoInternet4 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSignalWifiStatusbarConnectedNoInternet4 />
 * }
 * ```
 *
 * @category Component
 */
export const IconSignalWifiStatusbarConnectedNoInternet4 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconWbIncandescent } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWbIncandescent />
 * }
 * ```
 *
 * @category Component
 */
export const IconWbIncandescent = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

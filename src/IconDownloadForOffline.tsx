 ...
 *
 * ```typescript
 * import { IconDownloadForOffline } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDownloadForOffline />
 * }
 * ```
 *
 * @category Component
 */
export const IconDownloadForOffline = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

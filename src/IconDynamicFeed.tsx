 ...
 *
 * ```typescript
 * import { IconDynamicFeed } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDynamicFeed />
 * }
 * ```
 *
 * @category Component
 */
export const IconDynamicFeed = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

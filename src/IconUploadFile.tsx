 ...
 *
 * ```typescript
 * import { IconUploadFile } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconUploadFile />
 * }
 * ```
 *
 * @category Component
 */
export const IconUploadFile = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

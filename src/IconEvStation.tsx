 ...
 *
 * ```typescript
 * import { IconEvStation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEvStation />
 * }
 * ```
 *
 * @category Component
 */
export const IconEvStation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

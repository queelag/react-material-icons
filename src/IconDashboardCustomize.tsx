 ...
 *
 * ```typescript
 * import { IconDashboardCustomize } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDashboardCustomize />
 * }
 * ```
 *
 * @category Component
 */
export const IconDashboardCustomize = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconWaterDamage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWaterDamage />
 * }
 * ```
 *
 * @category Component
 */
export const IconWaterDamage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

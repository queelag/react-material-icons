 ...
 *
 * ```typescript
 * import { IconAirlineSeatLegroomExtra } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAirlineSeatLegroomExtra />
 * }
 * ```
 *
 * @category Component
 */
export const IconAirlineSeatLegroomExtra = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAddShoppingCart } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAddShoppingCart />
 * }
 * ```
 *
 * @category Component
 */
export const IconAddShoppingCart = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

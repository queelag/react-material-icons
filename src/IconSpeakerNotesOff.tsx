 ...
 *
 * ```typescript
 * import { IconSpeakerNotesOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSpeakerNotesOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconSpeakerNotesOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

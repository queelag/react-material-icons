 ...
 *
 * ```typescript
 * import { IconVideoSettings } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVideoSettings />
 * }
 * ```
 *
 * @category Component
 */
export const IconVideoSettings = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

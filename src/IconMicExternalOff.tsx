 ...
 *
 * ```typescript
 * import { IconMicExternalOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMicExternalOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconMicExternalOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

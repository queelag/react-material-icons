 ...
 *
 * ```typescript
 * import { IconAutoDelete } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAutoDelete />
 * }
 * ```
 *
 * @category Component
 */
export const IconAutoDelete = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

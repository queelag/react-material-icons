 ...
 *
 * ```typescript
 * import { IconDocumentScanner } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDocumentScanner />
 * }
 * ```
 *
 * @category Component
 */
export const IconDocumentScanner = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconNightShelter } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNightShelter />
 * }
 * ```
 *
 * @category Component
 */
export const IconNightShelter = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

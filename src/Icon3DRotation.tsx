 ...
 *
 * ```typescript
 * import { Icon3DRotation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <Icon3DRotation />
 * }
 * ```
 *
 * @category Component
 */
export const Icon3DRotation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

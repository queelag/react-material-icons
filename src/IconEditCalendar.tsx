 ...
 *
 * ```typescript
 * import { IconEditCalendar } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEditCalendar />
 * }
 * ```
 *
 * @category Component
 */
export const IconEditCalendar = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

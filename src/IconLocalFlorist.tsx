 ...
 *
 * ```typescript
 * import { IconLocalFlorist } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalFlorist />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalFlorist = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

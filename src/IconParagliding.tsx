 ...
 *
 * ```typescript
 * import { IconParagliding } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconParagliding />
 * }
 * ```
 *
 * @category Component
 */
export const IconParagliding = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

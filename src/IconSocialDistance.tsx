 ...
 *
 * ```typescript
 * import { IconSocialDistance } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSocialDistance />
 * }
 * ```
 *
 * @category Component
 */
export const IconSocialDistance = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

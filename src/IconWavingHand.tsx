 ...
 *
 * ```typescript
 * import { IconWavingHand } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWavingHand />
 * }
 * ```
 *
 * @category Component
 */
export const IconWavingHand = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconMultilineChart } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMultilineChart />
 * }
 * ```
 *
 * @category Component
 */
export const IconMultilineChart = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

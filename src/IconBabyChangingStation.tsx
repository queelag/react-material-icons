 ...
 *
 * ```typescript
 * import { IconBabyChangingStation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBabyChangingStation />
 * }
 * ```
 *
 * @category Component
 */
export const IconBabyChangingStation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

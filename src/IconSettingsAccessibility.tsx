 ...
 *
 * ```typescript
 * import { IconSettingsAccessibility } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsAccessibility />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsAccessibility = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

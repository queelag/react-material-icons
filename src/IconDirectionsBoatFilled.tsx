 ...
 *
 * ```typescript
 * import { IconDirectionsBoatFilled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDirectionsBoatFilled />
 * }
 * ```
 *
 * @category Component
 */
export const IconDirectionsBoatFilled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

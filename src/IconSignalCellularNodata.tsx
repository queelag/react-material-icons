 ...
 *
 * ```typescript
 * import { IconSignalCellularNodata } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSignalCellularNodata />
 * }
 * ```
 *
 * @category Component
 */
export const IconSignalCellularNodata = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

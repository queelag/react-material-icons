 ...
 *
 * ```typescript
 * import { IconDirectionsRun } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDirectionsRun />
 * }
 * ```
 *
 * @category Component
 */
export const IconDirectionsRun = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconHourglassBottom } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHourglassBottom />
 * }
 * ```
 *
 * @category Component
 */
export const IconHourglassBottom = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

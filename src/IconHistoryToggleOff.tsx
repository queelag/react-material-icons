 ...
 *
 * ```typescript
 * import { IconHistoryToggleOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHistoryToggleOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconHistoryToggleOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

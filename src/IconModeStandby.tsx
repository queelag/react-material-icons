 ...
 *
 * ```typescript
 * import { IconModeStandby } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconModeStandby />
 * }
 * ```
 *
 * @category Component
 */
export const IconModeStandby = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

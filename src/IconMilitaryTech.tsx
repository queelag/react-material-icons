 ...
 *
 * ```typescript
 * import { IconMilitaryTech } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMilitaryTech />
 * }
 * ```
 *
 * @category Component
 */
export const IconMilitaryTech = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

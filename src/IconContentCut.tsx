 ...
 *
 * ```typescript
 * import { IconContentCut } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconContentCut />
 * }
 * ```
 *
 * @category Component
 */
export const IconContentCut = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconCircleNotifications } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCircleNotifications />
 * }
 * ```
 *
 * @category Component
 */
export const IconCircleNotifications = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

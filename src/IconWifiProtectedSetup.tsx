 ...
 *
 * ```typescript
 * import { IconWifiProtectedSetup } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWifiProtectedSetup />
 * }
 * ```
 *
 * @category Component
 */
export const IconWifiProtectedSetup = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFollowTheSigns } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFollowTheSigns />
 * }
 * ```
 *
 * @category Component
 */
export const IconFollowTheSigns = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

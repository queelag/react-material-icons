 ...
 *
 * ```typescript
 * import { IconNoEncryption } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNoEncryption />
 * }
 * ```
 *
 * @category Component
 */
export const IconNoEncryption = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

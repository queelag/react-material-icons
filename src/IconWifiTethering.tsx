 ...
 *
 * ```typescript
 * import { IconWifiTethering } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWifiTethering />
 * }
 * ```
 *
 * @category Component
 */
export const IconWifiTethering = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

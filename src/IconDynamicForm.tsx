 ...
 *
 * ```typescript
 * import { IconDynamicForm } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDynamicForm />
 * }
 * ```
 *
 * @category Component
 */
export const IconDynamicForm = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconWifiTetheringErrorRounded } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWifiTetheringErrorRounded />
 * }
 * ```
 *
 * @category Component
 */
export const IconWifiTetheringErrorRounded = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

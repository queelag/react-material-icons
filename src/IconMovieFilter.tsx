 ...
 *
 * ```typescript
 * import { IconMovieFilter } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMovieFilter />
 * }
 * ```
 *
 * @category Component
 */
export const IconMovieFilter = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

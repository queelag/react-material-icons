 ...
 *
 * ```typescript
 * import { IconWrongLocation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWrongLocation />
 * }
 * ```
 *
 * @category Component
 */
export const IconWrongLocation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

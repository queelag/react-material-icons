 ...
 *
 * ```typescript
 * import { IconSwitchVideo } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSwitchVideo />
 * }
 * ```
 *
 * @category Component
 */
export const IconSwitchVideo = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconHdrOnSelect } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHdrOnSelect />
 * }
 * ```
 *
 * @category Component
 */
export const IconHdrOnSelect = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconTrackChanges } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTrackChanges />
 * }
 * ```
 *
 * @category Component
 */
export const IconTrackChanges = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

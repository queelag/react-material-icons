 ...
 *
 * ```typescript
 * import { IconCardGiftcard } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCardGiftcard />
 * }
 * ```
 *
 * @category Component
 */
export const IconCardGiftcard = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

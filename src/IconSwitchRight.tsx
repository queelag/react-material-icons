 ...
 *
 * ```typescript
 * import { IconSwitchRight } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSwitchRight />
 * }
 * ```
 *
 * @category Component
 */
export const IconSwitchRight = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

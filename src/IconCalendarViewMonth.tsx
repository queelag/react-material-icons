 ...
 *
 * ```typescript
 * import { IconCalendarViewMonth } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCalendarViewMonth />
 * }
 * ```
 *
 * @category Component
 */
export const IconCalendarViewMonth = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconOfflinePin } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOfflinePin />
 * }
 * ```
 *
 * @category Component
 */
export const IconOfflinePin = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

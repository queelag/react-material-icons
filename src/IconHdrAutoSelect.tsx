 ...
 *
 * ```typescript
 * import { IconHdrAutoSelect } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHdrAutoSelect />
 * }
 * ```
 *
 * @category Component
 */
export const IconHdrAutoSelect = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

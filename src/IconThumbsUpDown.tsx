 ...
 *
 * ```typescript
 * import { IconThumbsUpDown } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconThumbsUpDown />
 * }
 * ```
 *
 * @category Component
 */
export const IconThumbsUpDown = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

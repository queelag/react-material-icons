 ...
 *
 * ```typescript
 * import { IconDoDisturbOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDoDisturbOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconDoDisturbOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

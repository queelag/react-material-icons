 ...
 *
 * ```typescript
 * import { IconNotAccessible } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNotAccessible />
 * }
 * ```
 *
 * @category Component
 */
export const IconNotAccessible = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconHeadsetOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHeadsetOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconHeadsetOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

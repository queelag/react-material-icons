 ...
 *
 * ```typescript
 * import { IconFrontHand } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFrontHand />
 * }
 * ```
 *
 * @category Component
 */
export const IconFrontHand = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

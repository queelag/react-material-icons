 ...
 *
 * ```typescript
 * import { IconFormatListNumberedRtl } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatListNumberedRtl />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatListNumberedRtl = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

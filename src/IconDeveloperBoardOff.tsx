 ...
 *
 * ```typescript
 * import { IconDeveloperBoardOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDeveloperBoardOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconDeveloperBoardOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

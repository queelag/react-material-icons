 ...
 *
 * ```typescript
 * import { IconTextRotationAngledown } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTextRotationAngledown />
 * }
 * ```
 *
 * @category Component
 */
export const IconTextRotationAngledown = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

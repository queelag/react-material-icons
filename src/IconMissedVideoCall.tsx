 ...
 *
 * ```typescript
 * import { IconMissedVideoCall } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMissedVideoCall />
 * }
 * ```
 *
 * @category Component
 */
export const IconMissedVideoCall = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

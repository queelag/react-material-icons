 ...
 *
 * ```typescript
 * import { IconWifiTetheringOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWifiTetheringOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconWifiTetheringOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

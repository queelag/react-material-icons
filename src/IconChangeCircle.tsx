 ...
 *
 * ```typescript
 * import { IconChangeCircle } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconChangeCircle />
 * }
 * ```
 *
 * @category Component
 */
export const IconChangeCircle = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBeachAccess } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBeachAccess />
 * }
 * ```
 *
 * @category Component
 */
export const IconBeachAccess = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

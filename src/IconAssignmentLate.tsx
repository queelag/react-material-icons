 ...
 *
 * ```typescript
 * import { IconAssignmentLate } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAssignmentLate />
 * }
 * ```
 *
 * @category Component
 */
export const IconAssignmentLate = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

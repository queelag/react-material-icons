 ...
 *
 * ```typescript
 * import { IconBrunchDining } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBrunchDining />
 * }
 * ```
 *
 * @category Component
 */
export const IconBrunchDining = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

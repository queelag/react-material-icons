 ...
 *
 * ```typescript
 * import { IconTextRotationAngleup } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTextRotationAngleup />
 * }
 * ```
 *
 * @category Component
 */
export const IconTextRotationAngleup = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSquareFoot } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSquareFoot />
 * }
 * ```
 *
 * @category Component
 */
export const IconSquareFoot = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconOfflineShare } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOfflineShare />
 * }
 * ```
 *
 * @category Component
 */
export const IconOfflineShare = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

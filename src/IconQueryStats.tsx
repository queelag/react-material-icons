 ...
 *
 * ```typescript
 * import { IconQueryStats } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconQueryStats />
 * }
 * ```
 *
 * @category Component
 */
export const IconQueryStats = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

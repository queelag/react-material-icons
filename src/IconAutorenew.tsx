 ...
 *
 * ```typescript
 * import { IconAutorenew } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAutorenew />
 * }
 * ```
 *
 * @category Component
 */
export const IconAutorenew = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFamilyRestroom } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFamilyRestroom />
 * }
 * ```
 *
 * @category Component
 */
export const IconFamilyRestroom = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

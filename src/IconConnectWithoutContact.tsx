 ...
 *
 * ```typescript
 * import { IconConnectWithoutContact } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconConnectWithoutContact />
 * }
 * ```
 *
 * @category Component
 */
export const IconConnectWithoutContact = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

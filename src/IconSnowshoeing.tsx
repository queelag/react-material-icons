 ...
 *
 * ```typescript
 * import { IconSnowshoeing } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSnowshoeing />
 * }
 * ```
 *
 * @category Component
 */
export const IconSnowshoeing = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

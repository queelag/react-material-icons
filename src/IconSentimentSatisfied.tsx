 ...
 *
 * ```typescript
 * import { IconSentimentSatisfied } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSentimentSatisfied />
 * }
 * ```
 *
 * @category Component
 */
export const IconSentimentSatisfied = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

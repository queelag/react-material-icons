 ...
 *
 * ```typescript
 * import { IconFilterTiltShift } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFilterTiltShift />
 * }
 * ```
 *
 * @category Component
 */
export const IconFilterTiltShift = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

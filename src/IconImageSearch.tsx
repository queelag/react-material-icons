 ...
 *
 * ```typescript
 * import { IconImageSearch } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconImageSearch />
 * }
 * ```
 *
 * @category Component
 */
export const IconImageSearch = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

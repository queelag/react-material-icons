 ...
 *
 * ```typescript
 * import { IconElectricMoped } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconElectricMoped />
 * }
 * ```
 *
 * @category Component
 */
export const IconElectricMoped = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

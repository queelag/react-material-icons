 ...
 *
 * ```typescript
 * import { IconMotionPhotosPaused } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMotionPhotosPaused />
 * }
 * ```
 *
 * @category Component
 */
export const IconMotionPhotosPaused = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconElectricalServices } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconElectricalServices />
 * }
 * ```
 *
 * @category Component
 */
export const IconElectricalServices = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

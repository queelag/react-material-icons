 ...
 *
 * ```typescript
 * import { IconFreeCancellation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFreeCancellation />
 * }
 * ```
 *
 * @category Component
 */
export const IconFreeCancellation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPhonelinkOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhonelinkOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhonelinkOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

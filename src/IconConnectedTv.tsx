 ...
 *
 * ```typescript
 * import { IconConnectedTv } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconConnectedTv />
 * }
 * ```
 *
 * @category Component
 */
export const IconConnectedTv = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

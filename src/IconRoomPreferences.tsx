 ...
 *
 * ```typescript
 * import { IconRoomPreferences } from '@queelag/react-material-icons'
 *
 * function App() {
 ...
 * @category Component
 */
export const IconRoomPreferences = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

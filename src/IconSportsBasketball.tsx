 ...
 *
 * ```typescript
 * import { IconSportsBasketball } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSportsBasketball />
 * }
 * ```
 *
 * @category Component
 */
export const IconSportsBasketball = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

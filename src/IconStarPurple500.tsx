 ...
 *
 * ```typescript
 * import { IconStarPurple500 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconStarPurple500 />
 * }
 * ```
 *
 * @category Component
 */
export const IconStarPurple500 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

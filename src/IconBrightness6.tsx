 ...
 *
 * ```typescript
 * import { IconBrightness6 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBrightness6 />
 * }
 * ```
 *
 * @category Component
 */
export const IconBrightness6 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

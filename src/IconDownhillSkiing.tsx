 ...
 *
 * ```typescript
 * import { IconDownhillSkiing } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDownhillSkiing />
 * }
 * ```
 *
 * @category Component
 */
export const IconDownhillSkiing = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

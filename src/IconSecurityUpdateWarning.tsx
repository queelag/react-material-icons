 ...
 *
 * ```typescript
 * import { IconSecurityUpdateWarning } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSecurityUpdateWarning />
 * }
 * ```
 *
 * @category Component
 */
export const IconSecurityUpdateWarning = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconReportGmailerrorred } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconReportGmailerrorred />
 * }
 * ```
 *
 * @category Component
 */
export const IconReportGmailerrorred = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

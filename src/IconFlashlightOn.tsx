 ...
 *
 * ```typescript
 * import { IconFlashlightOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlashlightOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlashlightOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

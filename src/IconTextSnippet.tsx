 ...
 *
 * ```typescript
 * import { IconTextSnippet } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTextSnippet />
 * }
 * ```
 *
 * @category Component
 */
export const IconTextSnippet = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

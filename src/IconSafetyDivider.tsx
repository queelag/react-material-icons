 ...
 *
 * ```typescript
 * import { IconSafetyDivider } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSafetyDivider />
 * }
 * ```
 *
 * @category Component
 */
export const IconSafetyDivider = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSecurityUpdateGood } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSecurityUpdateGood />
 * }
 * ```
 *
 * @category Component
 */
export const IconSecurityUpdateGood = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

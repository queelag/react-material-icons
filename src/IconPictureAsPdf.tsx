 ...
 *
 * ```typescript
 * import { IconPictureAsPdf } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPictureAsPdf />
 * }
 * ```
 *
 * @category Component
 */
export const IconPictureAsPdf = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

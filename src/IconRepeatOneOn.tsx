 ...
 *
 * ```typescript
 * import { IconRepeatOneOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRepeatOneOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconRepeatOneOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

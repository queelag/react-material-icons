 ...
 *
 * ```typescript
 * import { IconSystemSecurityUpdateWarning } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSystemSecurityUpdateWarning />
 * }
 * ```
 *
 * @category Component
 */
export const IconSystemSecurityUpdateWarning = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAddToHomeScreen } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAddToHomeScreen />
 * }
 * ```
 *
 * @category Component
 */
export const IconAddToHomeScreen = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconHomeRepairService } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHomeRepairService />
 * }
 * ```
 *
 * @category Component
 */
export const IconHomeRepairService = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

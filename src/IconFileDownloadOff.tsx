 ...
 *
 * ```typescript
 * import { IconFileDownloadOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFileDownloadOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconFileDownloadOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

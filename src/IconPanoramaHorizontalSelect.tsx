 ...
 *
 * ```typescript
 * import { IconPanoramaHorizontalSelect } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPanoramaHorizontalSelect />
 * }
 * ```
 *
 * @category Component
 */
export const IconPanoramaHorizontalSelect = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

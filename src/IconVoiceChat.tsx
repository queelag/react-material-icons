 ...
 *
 * ```typescript
 * import { IconVoiceChat } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVoiceChat />
 * }
 * ```
 *
 * @category Component
 */
export const IconVoiceChat = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconLocalPolice } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalPolice />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalPolice = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconRunCircle } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRunCircle />
 * }
 * ```
 *
 * @category Component
 */
export const IconRunCircle = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

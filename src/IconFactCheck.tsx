 ...
 *
 * ```typescript
 * import { IconFactCheck } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFactCheck />
 * }
 * ```
 *
 * @category Component
 */
export const IconFactCheck = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

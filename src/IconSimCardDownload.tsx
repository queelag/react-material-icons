 ...
 *
 * ```typescript
 * import { IconSimCardDownload } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSimCardDownload />
 * }
 * ```
 *
 * @category Component
 */
export const IconSimCardDownload = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

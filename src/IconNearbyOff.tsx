 ...
 *
 * ```typescript
 * import { IconNearbyOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNearbyOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconNearbyOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconModeNight } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconModeNight />
 * }
 * ```
 *
 * @category Component
 */
export const IconModeNight = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

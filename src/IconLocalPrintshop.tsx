 ...
 *
 * ```typescript
 * import { IconLocalPrintshop } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalPrintshop />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalPrintshop = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

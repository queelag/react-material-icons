 ...
 *
 * ```typescript
 * import { IconSubtitlesOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSubtitlesOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconSubtitlesOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconDoubleArrow } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDoubleArrow />
 * }
 * ```
 *
 * @category Component
 */
export const IconDoubleArrow = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

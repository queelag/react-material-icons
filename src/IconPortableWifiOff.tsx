 ...
 *
 * ```typescript
 * import { IconPortableWifiOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPortableWifiOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconPortableWifiOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

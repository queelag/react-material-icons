 ...
 *
 * ```typescript
 * import { IconSdStorage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSdStorage />
 * }
 * ```
 *
 * @category Component
 */
export const IconSdStorage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

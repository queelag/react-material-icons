 ...
 *
 * ```typescript
 * import { IconSmokingRooms } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSmokingRooms />
 * }
 * ```
 *
 * @category Component
 */
export const IconSmokingRooms = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

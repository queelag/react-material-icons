 ...
 *
 * ```typescript
 * import { IconVolunteerActivism } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVolunteerActivism />
 * }
 * ```
 *
 * @category Component
 */
export const IconVolunteerActivism = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

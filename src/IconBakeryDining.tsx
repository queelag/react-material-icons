 ...
 *
 * ```typescript
 * import { IconBakeryDining } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBakeryDining />
 * }
 * ```
 *
 * @category Component
 */
export const IconBakeryDining = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

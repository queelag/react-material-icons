 ...
 *
 * ```typescript
 * import { IconPriceCheck } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPriceCheck />
 * }
 * ```
 *
 * @category Component
 */
export const IconPriceCheck = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

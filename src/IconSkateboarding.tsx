 ...
 *
 * ```typescript
 * import { IconSkateboarding } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSkateboarding />
 * }
 * ```
 *
 * @category Component
 */
export const IconSkateboarding = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

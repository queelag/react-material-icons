 ...
 *
 * ```typescript
 * import { IconHouseboat } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHouseboat />
 * }
 * ```
 *
 * @category Component
 */
export const IconHouseboat = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconOtherHouses } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOtherHouses />
 * }
 * ```
 *
 * @category Component
 */
export const IconOtherHouses = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconEditLocationAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEditLocationAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconEditLocationAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

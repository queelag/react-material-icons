 ...
 *
 * ```typescript
 * import { IconGridGoldenratio } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconGridGoldenratio />
 * }
 * ```
 *
 * @category Component
 */
export const IconGridGoldenratio = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

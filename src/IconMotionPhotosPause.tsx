 ...
 *
 * ```typescript
 * import { IconMotionPhotosPause } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMotionPhotosPause />
 * }
 * ```
 *
 * @category Component
 */
export const IconMotionPhotosPause = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconDeviceHub } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDeviceHub />
 * }
 * ```
 *
 * @category Component
 */
export const IconDeviceHub = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

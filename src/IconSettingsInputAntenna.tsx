 ...
 *
 * ```typescript
 * import { IconSettingsInputAntenna } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsInputAntenna />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsInputAntenna = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

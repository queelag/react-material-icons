 ...
 *
 * ```typescript
 * import { IconFormatColorText } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatColorText />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatColorText = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

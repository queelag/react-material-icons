 ...
 *
 * ```typescript
 * import { IconFormatUnderlined } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatUnderlined />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatUnderlined = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

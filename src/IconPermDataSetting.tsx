 ...
 *
 * ```typescript
 * import { IconPermDataSetting } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPermDataSetting />
 * }
 * ```
 *
 * @category Component
 */
export const IconPermDataSetting = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPlayForWork } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPlayForWork />
 * }
 * ```
 *
 * @category Component
 */
export const IconPlayForWork = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

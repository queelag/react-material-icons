 ...
 *
 * ```typescript
 * import { IconHolidayVillage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHolidayVillage />
 * }
 * ```
 *
 * @category Component
 */
export const IconHolidayVillage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

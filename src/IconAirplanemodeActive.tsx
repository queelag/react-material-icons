 ...
 *
 * ```typescript
 * import { IconAirplanemodeActive } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAirplanemodeActive />
 * }
 * ```
 *
 * @category Component
 */
export const IconAirplanemodeActive = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconEmojiEvents } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEmojiEvents />
 * }
 * ```
 *
 * @category Component
 */
export const IconEmojiEvents = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

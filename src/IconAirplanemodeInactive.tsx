 ...
 *
 * ```typescript
 * import { IconAirplanemodeInactive } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAirplanemodeInactive />
 * }
 * ```
 *
 * @category Component
 */
export const IconAirplanemodeInactive = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

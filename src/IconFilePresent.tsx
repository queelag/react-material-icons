 ...
 *
 * ```typescript
 * import { IconFilePresent } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFilePresent />
 * }
 * ```
 *
 * @category Component
 */
export const IconFilePresent = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBluetoothDisabled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBluetoothDisabled />
 * }
 * ```
 *
 * @category Component
 */
export const IconBluetoothDisabled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

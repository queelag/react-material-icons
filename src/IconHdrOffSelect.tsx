 ...
 *
 * ```typescript
 * import { IconHdrOffSelect } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHdrOffSelect />
 * }
 * ```
 *
 * @category Component
 */
export const IconHdrOffSelect = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

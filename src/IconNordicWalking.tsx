 ...
 *
 * ```typescript
 * import { IconNordicWalking } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNordicWalking />
 * }
 * ```
 *
 * @category Component
 */
export const IconNordicWalking = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFormatItalic } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatItalic />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatItalic = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

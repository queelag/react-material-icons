 ...
 *
 * ```typescript
 * import { IconRoundedCorner } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRoundedCorner />
 * }
 * ```
 *
 * @category Component
 */
export const IconRoundedCorner = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

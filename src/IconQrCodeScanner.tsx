 ...
 *
 * ```typescript
 * import { IconQrCodeScanner } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconQrCodeScanner />
 * }
 * ```
 *
 * @category Component
 */
export const IconQrCodeScanner = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

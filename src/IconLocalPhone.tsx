 ...
 *
 * ```typescript
 * import { IconLocalPhone } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalPhone />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalPhone = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

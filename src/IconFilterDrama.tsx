 ...
 *
 * ```typescript
 * import { IconFilterDrama } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFilterDrama />
 * }
 * ```
 *
 * @category Component
 */
export const IconFilterDrama = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

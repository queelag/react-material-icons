 ...
 *
 * ```typescript
 * import { IconViewQuilt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconViewQuilt />
 * }
 * ```
 *
 * @category Component
 */
export const IconViewQuilt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

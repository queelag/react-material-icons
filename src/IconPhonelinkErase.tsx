 ...
 *
 * ```typescript
 * import { IconPhonelinkErase } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhonelinkErase />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhonelinkErase = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

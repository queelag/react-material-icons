 ...
 *
 * ```typescript
 * import { IconRuleFolder } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRuleFolder />
 * }
 * ```
 *
 * @category Component
 */
export const IconRuleFolder = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

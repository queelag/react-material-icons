 ...
 *
 * ```typescript
 * import { IconDownloadDone } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDownloadDone />
 * }
 * ```
 *
 * @category Component
 */
export const IconDownloadDone = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

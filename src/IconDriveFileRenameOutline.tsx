 ...
 *
 * ```typescript
 * import { IconDriveFileRenameOutline } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDriveFileRenameOutline />
 * }
 * ```
 *
 * @category Component
 */
export const IconDriveFileRenameOutline = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

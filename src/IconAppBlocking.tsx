 ...
 *
 * ```typescript
 * import { IconAppBlocking } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAppBlocking />
 * }
 * ```
 *
 * @category Component
 */
export const IconAppBlocking = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconNotificationsActive } from '@queelag/react-material-icons'
 *
 * function App() {
 ...
 * @category Component
 */
export const IconNotificationsActive = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

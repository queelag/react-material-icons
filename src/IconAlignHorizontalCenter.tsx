 ...
 *
 * ```typescript
 * import { IconAlignHorizontalCenter } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAlignHorizontalCenter />
 * }
 * ```
 *
 * @category Component
 */
export const IconAlignHorizontalCenter = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

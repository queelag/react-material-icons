 ...
 *
 * ```typescript
 * import { IconFormatListBulleted } from '@queelag/react-material-icons'
 *
 * function App() {
 ...
 * @category Component
 */
export const IconFormatListBulleted = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

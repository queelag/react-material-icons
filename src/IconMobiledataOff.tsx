 ...
 *
 * ```typescript
 * import { IconMobiledataOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMobiledataOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconMobiledataOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

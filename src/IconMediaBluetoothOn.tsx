 ...
 *
 * ```typescript
 * import { IconMediaBluetoothOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMediaBluetoothOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconMediaBluetoothOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

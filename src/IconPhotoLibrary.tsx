 ...
 *
 * ```typescript
 * import { IconPhotoLibrary } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhotoLibrary />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhotoLibrary = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

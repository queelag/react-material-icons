 ...
 *
 * ```typescript
 * import { IconPersonalInjury } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPersonalInjury />
 * }
 * ```
 *
 * @category Component
 */
export const IconPersonalInjury = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

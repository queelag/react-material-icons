 ...
 *
 * ```typescript
 * import { IconChecklistRtl } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconChecklistRtl />
 * }
 * ```
 *
 * @category Component
 */
export const IconChecklistRtl = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

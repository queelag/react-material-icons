 ...
 *
 * ```typescript
 * import { IconSettingsApplications } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsApplications />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsApplications = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

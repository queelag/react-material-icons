 ...
 *
 * ```typescript
 * import { IconEventAvailable } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEventAvailable />
 * }
 * ```
 *
 * @category Component
 */
export const IconEventAvailable = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconForward30 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconForward30 />
 * }
 * ```
 *
 * @category Component
 */
export const IconForward30 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconOnlinePrediction } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOnlinePrediction />
 * }
 * ```
 *
 * @category Component
 */
export const IconOnlinePrediction = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPrecisionManufacturing } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPrecisionManufacturing />
 * }
 * ```
 *
 * @category Component
 */
export const IconPrecisionManufacturing = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconLocalDrink } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalDrink />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalDrink = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

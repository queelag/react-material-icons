 ...
 *
 * ```typescript
 * import { IconHPlusMobiledata } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHPlusMobiledata />
 * }
 * ```
 *
 * @category Component
 */
export const IconHPlusMobiledata = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

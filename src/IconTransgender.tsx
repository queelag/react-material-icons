 ...
 *
 * ```typescript
 * import { IconTransgender } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTransgender />
 * }
 * ```
 *
 * @category Component
 */
export const IconTransgender = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

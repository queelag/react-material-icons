 ...
 *
 * ```typescript
 * import { IconEditNotifications } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEditNotifications />
 * }
 * ```
 *
 * @category Component
 */
export const IconEditNotifications = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

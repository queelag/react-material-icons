 ...
 *
 * ```typescript
 * import { IconSendAndArchive } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSendAndArchive />
 * }
 * ```
 *
 * @category Component
 */
export const IconSendAndArchive = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAddToDrive } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAddToDrive />
 * }
 * ```
 *
 * @category Component
 */
export const IconAddToDrive = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

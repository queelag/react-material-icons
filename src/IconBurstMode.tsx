 ...
 *
 * ```typescript
 * import { IconBurstMode } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBurstMode />
 * }
 * ```
 *
 * @category Component
 */
export const IconBurstMode = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFormatSize } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatSize />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatSize = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

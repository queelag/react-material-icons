 ...
 *
 * ```typescript
 * import { IconPanoramaHorizontal } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPanoramaHorizontal />
 * }
 * ```
 *
 * @category Component
 */
export const IconPanoramaHorizontal = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

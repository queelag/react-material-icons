 ...
 *
 * ```typescript
 * import { IconHealthAndSafety } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHealthAndSafety />
 * }
 * ```
 *
 * @category Component
 */
export const IconHealthAndSafety = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

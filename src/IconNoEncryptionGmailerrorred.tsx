 ...
 *
 * ```typescript
 * import { IconNoEncryptionGmailerrorred } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNoEncryptionGmailerrorred />
 * }
 * ```
 *
 * @category Component
 */
export const IconNoEncryptionGmailerrorred = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconCastForEducation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCastForEducation />
 * }
 * ```
 *
 * @category Component
 */
export const IconCastForEducation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBedroomBaby } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBedroomBaby />
 * }
 * ```
 *
 * @category Component
 */
export const IconBedroomBaby = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

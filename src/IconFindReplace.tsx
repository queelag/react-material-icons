 ...
 *
 * ```typescript
 * import { IconFindReplace } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFindReplace />
 * }
 * ```
 *
 * @category Component
 */
export const IconFindReplace = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

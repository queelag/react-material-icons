 ...
 *
 * ```typescript
 * import { IconNotificationAdd } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNotificationAdd />
 * }
 * ```
 *
 * @category Component
 */
export const IconNotificationAdd = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

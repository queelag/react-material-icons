 ...
 *
 * ```typescript
 * import { IconBrightness3 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBrightness3 />
 * }
 * ```
 *
 * @category Component
 */
export const IconBrightness3 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

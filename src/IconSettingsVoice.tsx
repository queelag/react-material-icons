 ...
 *
 * ```typescript
 * import { IconSettingsVoice } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsVoice />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsVoice = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAssignmentReturned } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAssignmentReturned />
 * }
 * ```
 *
 * @category Component
 */
export const IconAssignmentReturned = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

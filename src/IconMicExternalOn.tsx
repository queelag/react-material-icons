 ...
 *
 * ```typescript
 * import { IconMicExternalOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMicExternalOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconMicExternalOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

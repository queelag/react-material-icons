 ...
 *
 * ```typescript
 * import { IconCreditCardOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCreditCardOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconCreditCardOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFilterHdr } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFilterHdr />
 * }
 * ```
 *
 * @category Component
 */
export const IconFilterHdr = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

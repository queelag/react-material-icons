 ...
 *
 * ```typescript
 * import { IconEdgesensorHigh } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEdgesensorHigh />
 * }
 * ```
 *
 * @category Component
 */
export const IconEdgesensorHigh = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

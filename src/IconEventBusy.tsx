 ...
 *
 * ```typescript
 * import { IconEventBusy } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEventBusy />
 * }
 * ```
 *
 * @category Component
 */
export const IconEventBusy = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

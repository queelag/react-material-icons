 ...
 *
 * ```typescript
 * import { IconSnowboarding } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSnowboarding />
 * }
 * ```
 *
 * @category Component
 */
export const IconSnowboarding = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPhoneLocked } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhoneLocked />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhoneLocked = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconNoBackpack } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNoBackpack />
 * }
 * ```
 *
 * @category Component
 */
export const IconNoBackpack = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

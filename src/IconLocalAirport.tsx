 ...
 *
 * ```typescript
 * import { IconLocalAirport } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalAirport />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalAirport = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAssistantDirection } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAssistantDirection />
 * }
 * ```
 *
 * @category Component
 */
export const IconAssistantDirection = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

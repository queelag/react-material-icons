 ...
 *
 * ```typescript
 * import { IconSwitchLeft } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSwitchLeft />
 * }
 * ```
 *
 * @category Component
 */
export const IconSwitchLeft = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconLibraryAddCheck } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLibraryAddCheck />
 * }
 * ```
 *
 * @category Component
 */
export const IconLibraryAddCheck = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconDataSaverOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDataSaverOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconDataSaverOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

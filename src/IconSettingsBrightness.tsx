 ...
 *
 * ```typescript
 * import { IconSettingsBrightness } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsBrightness />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsBrightness = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPhoneForwarded } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhoneForwarded />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhoneForwarded = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSubscriptions } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSubscriptions />
 * }
 * ```
 *
 * @category Component
 */
export const IconSubscriptions = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

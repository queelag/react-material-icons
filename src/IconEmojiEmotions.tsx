 ...
 *
 * ```typescript
 * import { IconEmojiEmotions } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEmojiEmotions />
 * }
 * ```
 *
 * @category Component
 */
export const IconEmojiEmotions = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

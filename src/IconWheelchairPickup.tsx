 ...
 *
 * ```typescript
 * import { IconWheelchairPickup } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconWheelchairPickup />
 * }
 * ```
 *
 * @category Component
 */
export const IconWheelchairPickup = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

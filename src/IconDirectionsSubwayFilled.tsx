 ...
 *
 * ```typescript
 * import { IconDirectionsSubwayFilled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDirectionsSubwayFilled />
 * }
 * ```
 *
 * @category Component
 */
export const IconDirectionsSubwayFilled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

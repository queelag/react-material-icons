 ...
 *
 * ```typescript
 * import { IconEmojiFoodBeverage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEmojiFoodBeverage />
 * }
 * ```
 *
 * @category Component
 */
export const IconEmojiFoodBeverage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

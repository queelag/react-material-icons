 ...
 *
 * ```typescript
 * import { IconDriveFileMove } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDriveFileMove />
 * }
 * ```
 *
 * @category Component
 */
export const IconDriveFileMove = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

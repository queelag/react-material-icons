 ...
 *
 * ```typescript
 * import { IconDirectionsOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDirectionsOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconDirectionsOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

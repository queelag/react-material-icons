 ...
 *
 * ```typescript
 * import { IconBorderHorizontal } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBorderHorizontal />
 * }
 * ```
 *
 * @category Component
 */
export const IconBorderHorizontal = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPhonePaused } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhonePaused />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhonePaused = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSupervisedUserCircle } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSupervisedUserCircle />
 * }
 * ```
 *
 * @category Component
 */
export const IconSupervisedUserCircle = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

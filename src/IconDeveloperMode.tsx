 ...
 *
 * ```typescript
 * import { IconDeveloperMode } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDeveloperMode />
 * }
 * ```
 *
 * @category Component
 */
export const IconDeveloperMode = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

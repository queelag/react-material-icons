 ...
 *
 * ```typescript
 * import { IconSwitchAccount } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSwitchAccount />
 * }
 * ```
 *
 * @category Component
 */
export const IconSwitchAccount = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

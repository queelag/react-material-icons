 ...
 *
 * ```typescript
 * import { IconOpenInNewOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOpenInNewOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconOpenInNewOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

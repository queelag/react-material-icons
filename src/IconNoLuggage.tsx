 ...
 *
 * ```typescript
 * import { IconNoLuggage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNoLuggage />
 * }
 * ```
 *
 * @category Component
 */
export const IconNoLuggage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

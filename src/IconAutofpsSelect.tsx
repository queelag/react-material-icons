 ...
 *
 * ```typescript
 * import { IconAutofpsSelect } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAutofpsSelect />
 * }
 * ```
 *
 * @category Component
 */
export const IconAutofpsSelect = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

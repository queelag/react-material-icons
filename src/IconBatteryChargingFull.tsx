 ...
 *
 * ```typescript
 * import { IconBatteryChargingFull } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBatteryChargingFull />
 * }
 * ```
 *
 * @category Component
 */
export const IconBatteryChargingFull = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

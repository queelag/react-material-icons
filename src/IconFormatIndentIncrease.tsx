 ...
 *
 * ```typescript
 * import { IconFormatIndentIncrease } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatIndentIncrease />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatIndentIncrease = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

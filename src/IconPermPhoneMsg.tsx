 ...
 *
 * ```typescript
 * import { IconPermPhoneMsg } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPermPhoneMsg />
 * }
 * ```
 *
 * @category Component
 */
export const IconPermPhoneMsg = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

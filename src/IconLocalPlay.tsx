 ...
 *
 * ```typescript
 * import { IconLocalPlay } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalPlay />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalPlay = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

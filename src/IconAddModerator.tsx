 ...
 *
 * ```typescript
 * import { IconAddModerator } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAddModerator />
 * }
 * ```
 *
 * @category Component
 */
export const IconAddModerator = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

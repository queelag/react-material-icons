 ...
 *
 * ```typescript
 * import { IconFilterNone } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFilterNone />
 * }
 * ```
 *
 * @category Component
 */
export const IconFilterNone = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

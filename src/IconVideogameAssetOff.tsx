 ...
 *
 * ```typescript
 * import { IconVideogameAssetOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVideogameAssetOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconVideogameAssetOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

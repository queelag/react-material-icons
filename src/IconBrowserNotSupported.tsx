 ...
 *
 * ```typescript
 * import { IconBrowserNotSupported } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBrowserNotSupported />
 * }
 * ```
 *
 * @category Component
 */
export const IconBrowserNotSupported = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

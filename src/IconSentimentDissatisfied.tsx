 ...
 *
 * ```typescript
 * import { IconSentimentDissatisfied } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSentimentDissatisfied />
 * }
 * ```
 *
 * @category Component
 */
export const IconSentimentDissatisfied = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFaceRetouchingOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFaceRetouchingOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconFaceRetouchingOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

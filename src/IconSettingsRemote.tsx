 ...
 *
 * ```typescript
 * import { IconSettingsRemote } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsRemote />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsRemote = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

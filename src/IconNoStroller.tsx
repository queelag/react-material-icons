 ...
 *
 * ```typescript
 * import { IconNoStroller } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNoStroller />
 * }
 * ```
 *
 * @category Component
 */
export const IconNoStroller = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

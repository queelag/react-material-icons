 ...
 *
 * ```typescript
 * import { IconSurroundSound } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSurroundSound />
 * }
 * ```
 *
 * @category Component
 */
export const IconSurroundSound = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPlagiarism } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPlagiarism />
 * }
 * ```
 *
 * @category Component
 */
export const IconPlagiarism = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

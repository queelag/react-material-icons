 ...
 *
 * ```typescript
 * import { IconNoMeetingRoom } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNoMeetingRoom />
 * }
 * ```
 *
 * @category Component
 */
export const IconNoMeetingRoom = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

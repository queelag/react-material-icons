 ...
 *
 * ```typescript
 * import { IconLayersClear } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLayersClear />
 * }
 * ```
 *
 * @category Component
 */
export const IconLayersClear = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

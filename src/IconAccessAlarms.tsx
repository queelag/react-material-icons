 ...
 *
 * ```typescript
 * import { IconAccessAlarms } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAccessAlarms />
 * }
 * ```
 *
 * @category Component
 */
export const IconAccessAlarms = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconEMobiledata } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEMobiledata />
 * }
 * ```
 *
 * @category Component
 */
export const IconEMobiledata = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

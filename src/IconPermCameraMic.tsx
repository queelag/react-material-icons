 ...
 *
 * ```typescript
 * import { IconPermCameraMic } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPermCameraMic />
 * }
 * ```
 *
 * @category Component
 */
export const IconPermCameraMic = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

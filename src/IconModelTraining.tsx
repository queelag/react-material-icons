 ...
 *
 * ```typescript
 * import { IconModelTraining } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconModelTraining />
 * }
 * ```
 *
 * @category Component
 */
export const IconModelTraining = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconLocationOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocationOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocationOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconHdrEnhancedSelect } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHdrEnhancedSelect />
 * }
 * ```
 *
 * @category Component
 */
export const IconHdrEnhancedSelect = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

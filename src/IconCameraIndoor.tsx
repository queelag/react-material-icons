 ...
 *
 * ```typescript
 * import { IconCameraIndoor } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCameraIndoor />
 * }
 * ```
 *
 * @category Component
 */
export const IconCameraIndoor = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

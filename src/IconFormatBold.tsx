 ...
 *
 * ```typescript
 * import { IconFormatBold } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatBold />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatBold = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

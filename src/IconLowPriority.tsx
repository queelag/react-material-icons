 ...
 *
 * ```typescript
 * import { IconLowPriority } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLowPriority />
 * }
 * ```
 *
 * @category Component
 */
export const IconLowPriority = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

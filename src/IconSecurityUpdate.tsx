 ...
 *
 * ```typescript
 * import { IconSecurityUpdate } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSecurityUpdate />
 * }
 * ```
 *
 * @category Component
 */
export const IconSecurityUpdate = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

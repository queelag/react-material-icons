 ...
 *
 * ```typescript
 * import { IconSettingsPower } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsPower />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsPower = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

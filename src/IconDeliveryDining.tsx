 ...
 *
 * ```typescript
 * import { IconDeliveryDining } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDeliveryDining />
 * }
 * ```
 *
 * @category Component
 */
export const IconDeliveryDining = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

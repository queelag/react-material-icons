 ...
 *
 * ```typescript
 * import { IconLocalLaundryService } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalLaundryService />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalLaundryService = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

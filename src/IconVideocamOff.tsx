 ...
 *
 * ```typescript
 * import { IconVideocamOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVideocamOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconVideocamOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

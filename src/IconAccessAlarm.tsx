 ...
 *
 * ```typescript
 * import { IconAccessAlarm } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAccessAlarm />
 * }
 * ```
 *
 * @category Component
 */
export const IconAccessAlarm = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

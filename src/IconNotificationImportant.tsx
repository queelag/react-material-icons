 ...
 *
 * ```typescript
 * import { IconNotificationImportant } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNotificationImportant />
 * }
 * ```
 *
 * @category Component
 */
export const IconNotificationImportant = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAlignHorizontalRight } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAlignHorizontalRight />
 * }
 * ```
 *
 * @category Component
 */
export const IconAlignHorizontalRight = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

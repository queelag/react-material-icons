 ...
 *
 * ```typescript
 * import { IconLockClock } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLockClock />
 * }
 * ```
 *
 * @category Component
 */
export const IconLockClock = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

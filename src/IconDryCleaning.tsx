 ...
 *
 * ```typescript
 * import { IconDryCleaning } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDryCleaning />
 * }
 * ```
 *
 * @category Component
 */
export const IconDryCleaning = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

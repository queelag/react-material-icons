 ...
 *
 * ```typescript
 * import { IconAlignVerticalBottom } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAlignVerticalBottom />
 * }
 * ```
 *
 * @category Component
 */
export const IconAlignVerticalBottom = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconMoveToInbox } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMoveToInbox />
 * }
 * ```
 *
 * @category Component
 */
export const IconMoveToInbox = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconEmojiTransportation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEmojiTransportation />
 * }
 * ```
 *
 * @category Component
 */
export const IconEmojiTransportation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

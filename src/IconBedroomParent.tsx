 ...
 *
 * ```typescript
 * import { IconBedroomParent } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBedroomParent />
 * }
 * ```
 *
 * @category Component
 */
export const IconBedroomParent = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

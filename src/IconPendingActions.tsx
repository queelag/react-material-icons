 ...
 *
 * ```typescript
 * import { IconPendingActions } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPendingActions />
 * }
 * ```
 *
 * @category Component
 */
export const IconPendingActions = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

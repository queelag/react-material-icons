 ...
 *
 * ```typescript
 * import { IconEuroSymbol } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEuroSymbol />
 * }
 * ```
 *
 * @category Component
 */
export const IconEuroSymbol = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

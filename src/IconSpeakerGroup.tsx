 ...
 *
 * ```typescript
 * import { IconSpeakerGroup } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSpeakerGroup />
 * }
 * ```
 *
 * @category Component
 */
export const IconSpeakerGroup = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

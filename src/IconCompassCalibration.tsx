 ...
 *
 * ```typescript
 * import { IconCompassCalibration } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCompassCalibration />
 * }
 * ```
 *
 * @category Component
 */
export const IconCompassCalibration = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

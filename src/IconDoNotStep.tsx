 ...
 *
 * ```typescript
 * import { IconDoNotStep } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDoNotStep />
 * }
 * ```
 *
 * @category Component
 */
export const IconDoNotStep = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

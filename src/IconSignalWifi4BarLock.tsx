 ...
 *
 * ```typescript
 * import { IconSignalWifi4BarLock } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSignalWifi4BarLock />
 * }
 * ```
 *
 * @category Component
 */
export const IconSignalWifi4BarLock = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

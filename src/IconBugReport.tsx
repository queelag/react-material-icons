 ...
 *
 * ```typescript
 * import { IconBugReport } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBugReport />
 * }
 * ```
 *
 * @category Component
 */
export const IconBugReport = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

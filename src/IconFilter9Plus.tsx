 ...
 *
 * ```typescript
 * import { IconFilter9Plus } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFilter9Plus />
 * }
 * ```
 *
 * @category Component
 */
export const IconFilter9Plus = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconMonetizationOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMonetizationOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconMonetizationOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

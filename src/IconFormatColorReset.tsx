 ...
 *
 * ```typescript
 * import { IconFormatColorReset } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatColorReset />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatColorReset = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

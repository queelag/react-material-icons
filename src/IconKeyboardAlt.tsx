 ...
 *
 * ```typescript
 * import { IconKeyboardAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconKeyboardAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconKeyboardAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

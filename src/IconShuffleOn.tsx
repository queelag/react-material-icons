 ...
 *
 * ```typescript
 * import { IconShuffleOn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconShuffleOn />
 * }
 * ```
 *
 * @category Component
 */
export const IconShuffleOn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

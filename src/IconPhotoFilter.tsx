 ...
 *
 * ```typescript
 * import { IconPhotoFilter } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhotoFilter />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhotoFilter = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconEmojiSymbols } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEmojiSymbols />
 * }
 * ```
 *
 * @category Component
 */
export const IconEmojiSymbols = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

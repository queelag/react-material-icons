 ...
 *
 * ```typescript
 * import { IconViewSidebar } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconViewSidebar />
 * }
 * ```
 *
 * @category Component
 */
export const IconViewSidebar = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconViewComfy } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconViewComfy />
 * }
 * ```
 *
 * @category Component
 */
export const IconViewComfy = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

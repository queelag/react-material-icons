 ...
 *
 * ```typescript
 * import { IconDesignServices } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDesignServices />
 * }
 * ```
 *
 * @category Component
 */
export const IconDesignServices = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

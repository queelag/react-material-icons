 ...
 *
 * ```typescript
 * import { IconQueryBuilder } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconQueryBuilder />
 * }
 * ```
 *
 * @category Component
 */
export const IconQueryBuilder = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

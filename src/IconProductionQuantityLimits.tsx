 ...
 *
 * ```typescript
 * import { IconProductionQuantityLimits } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconProductionQuantityLimits />
 * }
 * ```
 *
 * @category Component
 */
export const IconProductionQuantityLimits = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

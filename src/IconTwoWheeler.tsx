 ...
 *
 * ```typescript
 * import { IconTwoWheeler } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTwoWheeler />
 * }
 * ```
 *
 * @category Component
 */
export const IconTwoWheeler = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

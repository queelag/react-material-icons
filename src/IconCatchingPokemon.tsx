 ...
 *
 * ```typescript
 * import { IconCatchingPokemon } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCatchingPokemon />
 * }
 * ```
 *
 * @category Component
 */
export const IconCatchingPokemon = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

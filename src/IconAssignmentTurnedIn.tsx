 ...
 *
 * ```typescript
 * import { IconAssignmentTurnedIn } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAssignmentTurnedIn />
 * }
 * ```
 *
 * @category Component
 */
export const IconAssignmentTurnedIn = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconRequestPage } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRequestPage />
 * }
 * ```
 *
 * @category Component
 */
export const IconRequestPage = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

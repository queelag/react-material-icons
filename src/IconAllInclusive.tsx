 ...
 *
 * ```typescript
 * import { IconAllInclusive } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAllInclusive />
 * }
 * ```
 *
 * @category Component
 */
export const IconAllInclusive = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

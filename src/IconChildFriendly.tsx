 ...
 *
 * ```typescript
 * import { IconChildFriendly } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconChildFriendly />
 * }
 * ```
 *
 * @category Component
 */
export const IconChildFriendly = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

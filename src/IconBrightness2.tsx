 ...
 *
 * ```typescript
 * import { IconBrightness2 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBrightness2 />
 * }
 * ```
 *
 * @category Component
 */
export const IconBrightness2 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBluetoothConnected } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBluetoothConnected />
 * }
 * ```
 *
 * @category Component
 */
export const IconBluetoothConnected = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

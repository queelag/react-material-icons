 ...
 *
 * ```typescript
 * import { IconRequestQuote } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRequestQuote />
 * }
 * ```
 *
 * @category Component
 */
export const IconRequestQuote = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconAccessTime } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAccessTime />
 * }
 * ```
 *
 * @category Component
 */
export const IconAccessTime = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSanitizer } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSanitizer />
 * }
 * ```
 *
 * @category Component
 */
export const IconSanitizer = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

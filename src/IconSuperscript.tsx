 ...
 *
 * ```typescript
 * import { IconSuperscript } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSuperscript />
 * }
 * ```
 *
 * @category Component
 */
export const IconSuperscript = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconMediaBluetoothOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMediaBluetoothOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconMediaBluetoothOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconDoDisturbAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDoDisturbAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconDoDisturbAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBatterySaver } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBatterySaver />
 * }
 * ```
 *
 * @category Component
 */
export const IconBatterySaver = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

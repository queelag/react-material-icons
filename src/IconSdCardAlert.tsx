 ...
 *
 * ```typescript
 * import { IconSdCardAlert } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSdCardAlert />
 * }
 * ```
 *
 * @category Component
 */
export const IconSdCardAlert = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

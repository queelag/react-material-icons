 ...
 *
 * ```typescript
 * import { IconNotListedLocation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNotListedLocation />
 * }
 * ```
 *
 * @category Component
 */
export const IconNotListedLocation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

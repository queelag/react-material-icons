 ...
 *
 * ```typescript
 * import { IconPersonPinCircle } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPersonPinCircle />
 * }
 * ```
 *
 * @category Component
 */
export const IconPersonPinCircle = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

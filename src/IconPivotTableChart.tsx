 ...
 *
 * ```typescript
 * import { IconPivotTableChart } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPivotTableChart />
 * }
 * ```
 *
 * @category Component
 */
export const IconPivotTableChart = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

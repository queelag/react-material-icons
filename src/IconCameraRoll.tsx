 ...
 *
 * ```typescript
 * import { IconCameraRoll } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCameraRoll />
 * }
 * ```
 *
 * @category Component
 */
export const IconCameraRoll = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

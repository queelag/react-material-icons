 ...
 *
 * ```typescript
 * import { IconMotionPhotosAuto } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMotionPhotosAuto />
 * }
 * ```
 *
 * @category Component
 */
export const IconMotionPhotosAuto = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

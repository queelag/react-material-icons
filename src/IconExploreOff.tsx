 ...
 *
 * ```typescript
 * import { IconExploreOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconExploreOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconExploreOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

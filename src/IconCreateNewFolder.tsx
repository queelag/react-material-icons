 ...
 *
 * ```typescript
 * import { IconCreateNewFolder } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconCreateNewFolder />
 * }
 * ```
 *
 * @category Component
 */
export const IconCreateNewFolder = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

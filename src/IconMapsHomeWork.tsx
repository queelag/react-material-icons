 ...
 *
 * ```typescript
 * import { IconMapsHomeWork } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMapsHomeWork />
 * }
 * ```
 *
 * @category Component
 */
export const IconMapsHomeWork = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconManageAccounts } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconManageAccounts />
 * }
 * ```
 *
 * @category Component
 */
export const IconManageAccounts = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

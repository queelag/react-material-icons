 ...
 *
 * ```typescript
 * import { IconVideoCameraBack } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconVideoCameraBack />
 * }
 * ```
 *
 * @category Component
 */
export const IconVideoCameraBack = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconNetworkLocked } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconNetworkLocked />
 * }
 * ```
 *
 * @category Component
 */
export const IconNetworkLocked = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

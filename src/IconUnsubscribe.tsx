 ...
 *
 * ```typescript
 * import { IconUnsubscribe } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconUnsubscribe />
 * }
 * ```
 *
 * @category Component
 */
export const IconUnsubscribe = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

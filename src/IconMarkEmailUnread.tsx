 ...
 *
 * ```typescript
 * import { IconMarkEmailUnread } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMarkEmailUnread />
 * }
 * ```
 *
 * @category Component
 */
export const IconMarkEmailUnread = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

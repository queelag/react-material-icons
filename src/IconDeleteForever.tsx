 ...
 *
 * ```typescript
 * import { IconDeleteForever } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDeleteForever />
 * }
 * ```
 *
 * @category Component
 */
export const IconDeleteForever = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

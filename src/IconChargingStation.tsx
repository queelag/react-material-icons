 ...
 *
 * ```typescript
 * import { IconChargingStation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconChargingStation />
 * }
 * ```
 *
 * @category Component
 */
export const IconChargingStation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

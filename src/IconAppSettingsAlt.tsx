 ...
 *
 * ```typescript
 * import { IconAppSettingsAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAppSettingsAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconAppSettingsAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconMarkAsUnread } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMarkAsUnread />
 * }
 * ```
 *
 * @category Component
 */
export const IconMarkAsUnread = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconBookmarkAdd } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconBookmarkAdd />
 * }
 * ```
 *
 * @category Component
 */
export const IconBookmarkAdd = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconDonutLarge } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDonutLarge />
 * }
 * ```
 *
 * @category Component
 */
export const IconDonutLarge = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

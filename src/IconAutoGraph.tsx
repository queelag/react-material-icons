 ...
 *
 * ```typescript
 * import { IconAutoGraph } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAutoGraph />
 * }
 * ```
 *
 * @category Component
 */
export const IconAutoGraph = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

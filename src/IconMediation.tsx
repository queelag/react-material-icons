 ...
 *
 * ```typescript
 * import { IconMediation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMediation />
 * }
 * ```
 *
 * @category Component
 */
export const IconMediation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconViewCarousel } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconViewCarousel />
 * }
 * ```
 *
 * @category Component
 */
export const IconViewCarousel = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

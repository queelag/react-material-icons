 ...
 *
 * ```typescript
 * import { IconTakeoutDining } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTakeoutDining />
 * }
 * ```
 *
 * @category Component
 */
export const IconTakeoutDining = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

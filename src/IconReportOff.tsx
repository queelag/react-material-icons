 ...
 *
 * ```typescript
 * import { IconReportOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconReportOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconReportOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

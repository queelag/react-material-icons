 ...
 *
 * ```typescript
 * import { Icon3GMobiledata } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <Icon3GMobiledata />
 * }
 * ```
 *
 * @category Component
 */
export const Icon3GMobiledata = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

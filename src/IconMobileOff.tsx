 ...
 *
 * ```typescript
 * import { IconMobileOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMobileOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconMobileOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

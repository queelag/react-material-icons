 ...
 *
 * ```typescript
 * import { IconSignalWifiConnectedNoInternet4 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSignalWifiConnectedNoInternet4 />
 * }
 * ```
 *
 * @category Component
 */
export const IconSignalWifiConnectedNoInternet4 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconPublicOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPublicOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconPublicOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconRemoveShoppingCart } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRemoveShoppingCart />
 * }
 * ```
 *
 * @category Component
 */
export const IconRemoveShoppingCart = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconHighQuality } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconHighQuality />
 * }
 * ```
 *
 * @category Component
 */
export const IconHighQuality = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFlightTakeoff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlightTakeoff />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlightTakeoff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

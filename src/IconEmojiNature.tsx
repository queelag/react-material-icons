 ...
 *
 * ```typescript
 * import { IconEmojiNature } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconEmojiNature />
 * }
 * ```
 *
 * @category Component
 */
export const IconEmojiNature = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSentimentVerySatisfied } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSentimentVerySatisfied />
 * }
 * ```
 *
 * @category Component
 */
export const IconSentimentVerySatisfied = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

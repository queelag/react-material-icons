 ...
 *
 * ```typescript
 * import { IconPhoneMissed } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhoneMissed />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhoneMissed = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

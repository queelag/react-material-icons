 ...
 *
 * ```typescript
 * import { IconPhotoSizeSelectLarge } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhotoSizeSelectLarge />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhotoSizeSelectLarge = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

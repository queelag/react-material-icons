 ...
 *
 * ```typescript
 * import { IconStarBorderPurple500 } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconStarBorderPurple500 />
 * }
 * ```
 *
 * @category Component
 */
export const IconStarBorderPurple500 = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

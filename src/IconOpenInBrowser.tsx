 ...
 *
 * ```typescript
 * import { IconOpenInBrowser } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconOpenInBrowser />
 * }
 * ```
 *
 * @category Component
 */
export const IconOpenInBrowser = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

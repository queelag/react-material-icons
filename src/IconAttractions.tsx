 ...
 *
 * ```typescript
 * import { IconAttractions } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAttractions />
 * }
 * ```
 *
 * @category Component
 */
export const IconAttractions = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

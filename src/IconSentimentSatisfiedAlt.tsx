 ...
 *
 * ```typescript
 * import { IconSentimentSatisfiedAlt } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSentimentSatisfiedAlt />
 * }
 * ```
 *
 * @category Component
 */
export const IconSentimentSatisfiedAlt = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

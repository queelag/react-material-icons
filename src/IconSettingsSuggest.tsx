 ...
 *
 * ```typescript
 * import { IconSettingsSuggest } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsSuggest />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsSuggest = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

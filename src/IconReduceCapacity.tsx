 ...
 *
 * ```typescript
 * import { IconReduceCapacity } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconReduceCapacity />
 * }
 * ```
 *
 * @category Component
 */
export const IconReduceCapacity = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

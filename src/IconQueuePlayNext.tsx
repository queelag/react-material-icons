 ...
 *
 * ```typescript
 * import { IconQueuePlayNext } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconQueuePlayNext />
 * }
 * ```
 *
 * @category Component
 */
export const IconQueuePlayNext = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconLocalCarWash } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconLocalCarWash />
 * }
 * ```
 *
 * @category Component
 */
export const IconLocalCarWash = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconGeneratingTokens } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconGeneratingTokens />
 * }
 * ```
 *
 * @category Component
 */
export const IconGeneratingTokens = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconFlutterDash } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlutterDash />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlutterDash = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconRecordVoiceOver } from '@queelag/react-material-icons'
 *
 * function App() {
 ...
 * @category Component
 */
export const IconRecordVoiceOver = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconThermostatAuto } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconThermostatAuto />
 * }
 * ```
 *
 * @category Component
 */
export const IconThermostatAuto = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

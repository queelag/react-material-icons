 ...
 *
 * ```typescript
 * import { IconDevicesOther } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDevicesOther />
 * }
 * ```
 *
 * @category Component
 */
export const IconDevicesOther = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

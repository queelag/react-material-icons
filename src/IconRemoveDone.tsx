 ...
 *
 * ```typescript
 * import { IconRemoveDone } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRemoveDone />
 * }
 * ```
 *
 * @category Component
 */
export const IconRemoveDone = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconSystemSecurityUpdate } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSystemSecurityUpdate />
 * }
 * ```
 *
 * @category Component
 */
export const IconSystemSecurityUpdate = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

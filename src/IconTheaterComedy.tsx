 ...
 *
 * ```typescript
 * import { IconTheaterComedy } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconTheaterComedy />
 * }
 * ```
 *
 * @category Component
 */
export const IconTheaterComedy = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

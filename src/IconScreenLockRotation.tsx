 ...
 *
 * ```typescript
 * import { IconScreenLockRotation } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconScreenLockRotation />
 * }
 * ```
 *
 * @category Component
 */
export const IconScreenLockRotation = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

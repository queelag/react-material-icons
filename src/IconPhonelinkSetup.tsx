 ...
 *
 * ```typescript
 * import { IconPhonelinkSetup } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhonelinkSetup />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhonelinkSetup = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

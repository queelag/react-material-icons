 ...
 *
 * ```typescript
 * import { IconRailwayAlert } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconRailwayAlert />
 * }
 * ```
 *
 * @category Component
 */
export const IconRailwayAlert = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

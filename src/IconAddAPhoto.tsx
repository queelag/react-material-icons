 ...
 *
 * ```typescript
 * import { IconAddAPhoto } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAddAPhoto />
 * }
 * ```
 *
 * @category Component
 */
export const IconAddAPhoto = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconGroupWork } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconGroupWork />
 * }
 * ```
 *
 * @category Component
 */
export const IconGroupWork = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

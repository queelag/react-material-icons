 ...
 *
 * ```typescript
 * import { IconFlipToFront } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFlipToFront />
 * }
 * ```
 *
 * @category Component
 */
export const IconFlipToFront = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

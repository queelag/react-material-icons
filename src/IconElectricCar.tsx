 ...
 *
 * ```typescript
 * import { IconElectricCar } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconElectricCar />
 * }
 * ```
 *
 * @category Component
 */
export const IconElectricCar = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

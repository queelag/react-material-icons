 ...
 *
 * ```typescript
 * import { IconPublishedWithChanges } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPublishedWithChanges />
 * }
 * ```
 *
 * @category Component
 */
export const IconPublishedWithChanges = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

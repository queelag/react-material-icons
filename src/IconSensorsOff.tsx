 ...
 *
 * ```typescript
 * import { IconSensorsOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSensorsOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconSensorsOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

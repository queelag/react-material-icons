 ...
 *
 * ```typescript
 * import { IconDirectionsBoat } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconDirectionsBoat />
 * }
 * ```
 *
 * @category Component
 */
export const IconDirectionsBoat = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

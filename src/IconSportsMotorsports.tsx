 ...
 *
 * ```typescript
 * import { IconSportsMotorsports } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSportsMotorsports />
 * }
 * ```
 *
 * @category Component
 */
export const IconSportsMotorsports = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

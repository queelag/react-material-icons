 ...
 *
 * ```typescript
 * import { IconKeyboardTab } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconKeyboardTab />
 * }
 * ```
 *
 * @category Component
 */
export const IconKeyboardTab = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

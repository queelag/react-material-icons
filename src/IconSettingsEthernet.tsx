 ...
 *
 * ```typescript
 * import { IconSettingsEthernet } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSettingsEthernet />
 * }
 * ```
 *
 * @category Component
 */
export const IconSettingsEthernet = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

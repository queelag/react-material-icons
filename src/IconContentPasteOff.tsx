 ...
 *
 * ```typescript
 * import { IconContentPasteOff } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconContentPasteOff />
 * }
 * ```
 *
 * @category Component
 */
export const IconContentPasteOff = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

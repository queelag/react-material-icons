 ...
 *
 * ```typescript
 * import { IconMarkChatUnread } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconMarkChatUnread />
 * }
 * ```
 *
 * @category Component
 */
export const IconMarkChatUnread = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

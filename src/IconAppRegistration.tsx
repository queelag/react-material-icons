 ...
 *
 * ```typescript
 * import { IconAppRegistration } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconAppRegistration />
 * }
 * ```
 *
 * @category Component
 */
export const IconAppRegistration = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

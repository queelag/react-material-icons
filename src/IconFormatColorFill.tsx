 ...
 *
 * ```typescript
 * import { IconFormatColorFill } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconFormatColorFill />
 * }
 * ```
 *
 * @category Component
 */
export const IconFormatColorFill = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

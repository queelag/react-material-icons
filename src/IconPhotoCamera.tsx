 ...
 *
 * ```typescript
 * import { IconPhotoCamera } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconPhotoCamera />
 * }
 * ```
 *
 * @category Component
 */
export const IconPhotoCamera = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

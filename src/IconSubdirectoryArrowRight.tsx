 ...
 *
 * ```typescript
 * import { IconSubdirectoryArrowRight } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconSubdirectoryArrowRight />
 * }
 * ```
 *
 * @category Component
 */
export const IconSubdirectoryArrowRight = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}

 ...
 *
 * ```typescript
 * import { IconReplayCircleFilled } from '@queelag/react-material-icons'
 *
 * function App() {
 *   return <IconReplayCircleFilled />
 * }
 * ```
 *
 * @category Component
 */
export const IconReplayCircleFilled = forwardRef((props: IconProps, ref: ForwardedRef<SVGSVGElement>) => {
  return (
    <Icon
      {...props}
